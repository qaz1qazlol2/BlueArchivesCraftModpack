 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "ftbquests.completed.65C8B0D68C47F76B", handler: (event: Internal.QuestObjectCompletedEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **server**.
 * 
 ...
 * The event is **not** cancellable.
*/
declare function onEvent(name: "ftbquests.completed.45505B3384D63FBC", handler: (event: Internal.QuestObjectCompletedEventJS) => void);
/**
 * 
 * The event fires on: **startup**, **client**.
 * 
...
declare function onForgeEvent(name: "org.infernalstudios.infernalexp.events.PostRightClickBlockEvent", handler: (event: any) => void);
